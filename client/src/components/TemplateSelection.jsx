...
// //         onClick={() => setStep("upload")} // Changed from "capture" to "upload"
...
//                 const usingLayout = layouts.vertical[template.frames];
//                 if (usingLayout) {
//                   // ✅ Set photosToCapture = frames (not numRows)
//                   setPhotosToCapture(template.frames);

//                   // ✅ Set printCopies = 1 by default
//                   if (!manualCopies) {
//                     setPrintCopies(1);
//                   }
          ...
          return (
            <div
              ...
              onClick={() => {
                ...
                const usingLayout = layouts.vertical[template.frames];
                if (usingLayout) {
                  // ✅ FIXED: Set photosToCapture = template.frames (NOT numRows)
                  setPhotosToCapture(template.frames);
